...
const INPUT_CLASS = 'jost w-full px-4 py-3 bg-transparent border border-[#E2D9CC] text-[#1C1C1C] placeholder-[#6B6560] text-sm font-light focus:border-[#B8956A] transition-colors duration-200 outline-none'
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-10">
          ...
          <div className="flex items-center justify-center gap-2 mt-3">
            <span className="block w-8 h-px bg-[#B8956A]" />
            <span className="block w-1.5 h-1.5 rounded-full bg-[#B8956A]" />
            <span className="block w-8 h-px bg-[#B8956A]" />
          </div>
        </div>
          ...
          <div className="flex justify-between items-center mt-1">
            ...
            {currentState === 'Login' ? (
              <button
                ...
                className="jost text-xs text-[#6B6560] hover:text-[#B8956A] transition-colors font-light"
              >
                Create account
              </button>
            ) : (
