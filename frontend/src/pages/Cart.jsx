        ...
        {cartData.map((item) => {
          ...
          return (
            <div
              ...
              className="py-5 border-b border-[#E2D9CC] flex items-center gap-4 sm:gap-6"
            >
              <img
              ...
              <div className="flex items-center gap-3 sm:gap-5 shrink-0">
                <div className="flex items-center border border-[#E2D9CC]">
                  ...
                  <span className="jost w-8 h-8 flex items-center justify-center text-sm text-[#1C1C1C] border-x border-[#E2D9CC]">
                    {item.quantity}
                  </span>
                  <button
      ...
      {cartData.length === 0 && (
        <div className="flex flex-col items-center justify-center py-24 text-center">
          ...
          <button
            ...
            className="jost text-[11px] tracking-[0.25em] uppercase border border-[#1C1C1C] text-[#1C1C1C] px-10 py-3 hover:bg-[#1C1C1C] hover:text-[#F9F6F0] transition-all duration-300"
          >
            Browse Collection
          </button>
        </div>
