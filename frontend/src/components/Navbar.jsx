...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center justify-between py-5 font-medium relative z-50">
          ...
          {token && profileDropdown && (
            <div className='absolute right-0 top-full mt-2 z-50'>
              <div className='flex flex-col gap-2 w-36 py-3 px-5 bg-slate-100 text-gray-500 rounded shadow'>
                ...
                <p onClick={() => { navigate('/orders'); setProfileDropdown(false) }} className='cursor-pointer hover:text-black'>Order</p>
      ...
      {/* Sidebar (mobile only) */}
      <div
        className={`sm:hidden fixed top-0 left-0 right-0 bottom-0 w-full overflow-y-auto bg-white z-50 transition-transform duration-300 ease-in-out
