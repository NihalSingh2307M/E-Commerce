...
const NewsLetterBox = () => {
  ...
  /* ── Subscribe button fill LEFT → RIGHT ─────────────────────────────── */
  useLayoutEffect(() => {
  ...
  return (
    <div ref={sectionRef} className='my-14 sm:my-20 py-14 sm:py-20 px-6 sm:px-16 bg-[#1C1C1C] text-center'>
      <div className='max-w-2xl mx-auto'>
        ...
        <form onSubmit={onSubmitHandler} className='nl-item flex flex-col sm:flex-row items-stretch sm:items-center gap-0 max-w-md mx-auto'>
          ...
          >
            <span className='btn-fill absolute inset-0 bg-[#D4B896] origin-left block' style={{ transform: 'scaleX(0)' }} />
